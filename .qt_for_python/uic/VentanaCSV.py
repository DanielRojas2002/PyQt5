...
"border-left: 5px solid gray;")
        ...
        self.layoutWidget1.setGeometry(QRect(20, 20, 331, 351))
...
"")
        ...
        self.layoutWidget2.setGeometry(QRect(380, 170, 311, 201))
...
#if QT_CONFIG(tooltip)
        self.tipo_fuente.setToolTip(QCoreApplication.translate("VentanaPrincipal", u"<html><head/><body><p>Cambiar el Tipo de Letra de Los Componentes</p></body></html>", None))
#endif // QT_CONFIG(tooltip)

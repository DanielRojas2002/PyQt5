...
class Ui_Ventana_Eliminar(object):
    def setupUi(self, Ventana_Eliminar):
        ...
        Ventana_Eliminar.resize(397, 307)
        Ventana_Eliminar.setStyleSheet("background-color: rgb(255, 255, 127);")
        ...
        self.titulo.setGeometry(QtCore.QRect(80, 10, 241, 31))
        font = QtGui.QFont()
...
"}")
        ...
        self.eliminarhecho.setGeometry(QtCore.QRect(310, 260, 31, 21))
        self.eliminarhecho.setText("")
        self.eliminarhecho.setTextFormat(QtCore.Qt.PlainText)
        self.eliminarhecho.setScaledContents(True)
        self.eliminarhecho.setObjectName("eliminarhecho")
        Ventana_Eliminar.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(Ventana_Eliminar)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 397, 21))
        self.menubar.setObjectName("menubar")
        Ventana_Eliminar.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(Ventana_Eliminar)
        self.statusbar.setObjectName("statusbar")
        Ventana_Eliminar.setStatusBar(self.statusbar)

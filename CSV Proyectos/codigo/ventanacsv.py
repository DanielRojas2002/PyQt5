...
class Ui_VentanaPrincipal(object):
    def setupUi(self, VentanaPrincipal):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("CSV Proyectos/multimedia/vector.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-left: 5px solid gray;")
        ...
        self.imagen.setText("")
        self.imagen.setPixmap(QtGui.QPixmap("CSV Proyectos/multimedia/vector.ico"))

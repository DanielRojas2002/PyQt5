...
class Ui_VentanaModificarRegistros(object):
    def setupUi(self, VentanaModificarRegistros):
        ...
        self.imagen.setText("")
        self.imagen.setPixmap(QtGui.QPixmap("CSV/mutimedia/base3.png"))
...
"}")
        ...
        self.imagen_2.setPixmap(QtGui.QPixmap("CSV/mutimedia/base3p.png"))
        ...
        self.imagen_3.setPixmap(QtGui.QPixmap("CSV/mutimedia/base3f.png"))
